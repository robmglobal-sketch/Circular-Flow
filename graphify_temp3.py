...
# Handle potential BOM in detect json if needed
try:
...
report = generate(G, communities, cohesion, labels, gods, surprises, detection, tokens, 'e:\\Fiverr\\Gig\\Gig 9\\Orders\\Project 0013\\website\\circlularflow', suggested_questions=questions)
