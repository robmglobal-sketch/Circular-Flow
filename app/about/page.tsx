          ...
          {[
            ...
            return (
              <button
                ...
                className={`flex items-center gap-2.5 px-5 py-3 rounded-[10px] font-heading text-sm sm:text-base whitespace-nowrap transition-all cursor-pointer border-none focus:outline-none ${
                  isActive
      ...
      <div className="max-w-[1440px] mx-auto px-6 sm:px-8 lg:px-12 py-16 lg:py-24 relative z-10">
          ...
          <div id="founder" className="animate-fade-in">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
              ...
              <div className="lg:col-span-4 space-y-6">
                ...
                {/* Credentials Card */}
                <div className="bg-[#F8FAFC] border border-slate-200 rounded-[10px] p-6 sm:p-8 shadow-xs relative overflow-hidden">
        ...
        {activeTab === "cf-framework" && (
          <div id="cf-framework" className="animate-fade-in space-y-12 max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {CF_FRAMEWORK.map((item, i) => {
                ...
                return (
                  <div
                    key={item.title}
                    className="bg-[#F8FAFC] border border-slate-200/90 rounded-[10px] p-8 sm:p-10 shadow-xs hover:shadow-md hover:border-[#18A0A8]/50 hover:-translate-y-1 transition-all duration-300 group relative overflow-hidden flex flex-col justify-between"
                  >
                    ...
                    <div>
                      <div className="w-12 h-12 rounded-[10px] bg-[var(--color-secondary)]/15 text-[var(--color-secondary-dark)] flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
            ...
            <div className="bg-[#163A5F] rounded-[10px] p-8 sm:p-12 text-center shadow-xl relative overflow-hidden border border-white/10">
        ...
        {activeTab === "starr" && (
          <div id="starr" className="animate-fade-in space-y-12 max-w-5xl mx-auto">
            ...
            <div className="space-y-4 sm:space-y-5">
              {STARR_ITEMS.map((item, idx) => {
                ...
                return (
                  <div
                    key={`${item.letter}-${idx}`}
                    className="flex flex-col sm:flex-row sm:items-center gap-5 sm:gap-8 p-6 sm:p-8 bg-[#F8FAFC] border border-slate-200/90 rounded-[10px] shadow-xs hover:border-[#18A0A8]/50 hover:bg-white hover:-translate-y-0.5 transition-all duration-300 group"
                  >
                    <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-[10px] bg-[var(--color-secondary)]/12 border border-[var(--color-secondary)]/30 flex items-center justify-center shrink-0 shadow-2xs group-hover:scale-105 transition-transform">
            ...
            <div className="bg-[#18A0A8]/8 border border-[#18A0A8]/25 rounded-[10px] p-8 sm:p-10 shadow-2xs">
        ...
        {activeTab === "mission" && (
          <div id="mission" className="animate-fade-in space-y-12 max-w-4xl mx-auto">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-[#163A5F] rounded-[10px] p-8 sm:p-14 shadow-xl relative overflow-hidden text-center border border-white/10">
                ...
                <p className="relative z-10 font-sans text-2xl sm:text-3.5xl !text-[#18A0A8] font-light italic leading-snug max-w-3xl mx-auto mb-6">
